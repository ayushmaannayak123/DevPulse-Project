"""
=============================================================
DevPulse -- Phase 5: A2A Agent Card
Publishes DevPulse for discovery by completely external agents.
An external agent only ever sees this card -- never the MCP
server, the GitHub API, or the LangGraph code underneath it.
=============================================================
"""

"""
=============================================================
DevPulse -- Phase 1: Real MCP Server (GitHub Intelligence Server)
=============================================================
Exposes 5 GitHub tools, 1 resource, and 1 prompt over the MCP
stdio transport. Every tool call here is a genuine HTTP request
to api.github.com -- no mock data.
"""
...
def _get(path: str, params: dict | None = None) -> tuple[int, dict]:
    ...
    try:
        r = httpx.get(
            f"{GITHUB_API}{path}", headers=_HEADERS, params=params,

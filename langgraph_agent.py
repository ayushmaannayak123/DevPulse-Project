"""
=============================================================
DevPulse -- Phase 4: LangGraph Multi-Agent Version
    ...
    async with mcp_session() as session:
        ...
        if response.choices[0].finish_reason == "tool_calls" and msg.tool_calls:
            ...
            for tc in msg.tool_calls:
                ...
                new_calls.append({"tool": tc.function.name, "result": tool_result})
            state["tool_calls_made"].extend(new_calls)
            ...
            follow_up = messages + [
                ...
                for tc, call in zip(msg.tool_calls, new_calls)
            ]
